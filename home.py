...
for i, bu in enumerate(tabela['BU']):
    if(tabela.loc[i, "ID_Requisição"] != ""):
        continue
    ...
    navegator.find_element_by_xpath('//*[@id="REQ_ADD_SRCH_BUSINESS_UNIT"]').send_keys(BU)
    ...
    navegator.find_element_by_xpath('//*[@id="REQ_LINE_WRK_INV_ITEM_ID$0"]').send_keys(item) #preencher com item
    ...
    navegator.find_element_by_xpath('//*[@id="REQ_LINE_QTY_REQ$0"]').send_keys(quantidade) #preencher quantidade
    ...
    navegator.find_element_by_xpath('//*[@id="REQ_LINE_SHIP_SHIPTO_ID$0"]').send_keys(budge_unidade) # Entrega
    ...
    navegator.find_element_by_xpath('//*[@id="OPERATING_UNIT$0"]').send_keys(budge_unidade) #preenchendo unidade de distribuição orçamentaria
    ...
    navegator.find_element_by_xpath('//*[@id="REQ_LINE_WRK_PRICE_REQ_C$0"]').send_keys(valor)
